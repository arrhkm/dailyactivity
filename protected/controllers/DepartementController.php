...
class DepartementController extends Controller
{
		...
		return array(
			...
			*/
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('index', 'view', 'create', 'update', 'admin','delete', 'deletejobtitle',  'jobtitle'),
	...
	public function acrtionJobtitle()
	{
		$model= new Jobtitle;
	...
	public function actionDeleteJobtitle()
	{
		$rsJobtitle = Jobtitle::model()->findByPk($_REQUEST['id']);
		$departement_id= $rsJobtitle->departement_id;
		if (isset($_REQUEST['id']))
		{

			$sql_del = "DELETE FROM jobtitle WHERE id= '$_REQUEST[id]'";
			$connect = yii::app()->db;
		...
		// if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser		
		if(!isset($_GET['ajax']))
			$this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('view', 'id'=>$departement_id));
	...
	public function actionJobtitle()
	{
	    ...
	    /*
	    if(isset($_POST['ajax']) && $_POST['ajax']==='jobtitle-jobtitle-form')
	    {
